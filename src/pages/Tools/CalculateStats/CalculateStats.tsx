...
const Calculate = () => {
    ...
    const onCalculateStatsPoke = useCallback((e: any) => {
        e.preventDefault();
        calculateStatsPoke();
    }, [calculateStatsPoke]);

    const onHandleLevel = useCallback((e: any, v: any) => {
        setStatLevel(v);
                                ...
                                <div className="col" style={{padding: 0}}>
                                    <table className="table-info battle-league">
                                        ...
                                        <tbody>
                                            ...
                                            <span className={dataLittleLeague ? dataLittleLeague.elidge ? '' : "text-danger" : ''}>Little Cup{dataLittleLeague ? dataLittleLeague.elidge ? "" : <span> (Not Elidge)</span>: ""}</span>
                                            </td></tr>
                                            <tr>
                                                <td>Level</td>
                                            ...
                                            <tr className="text-center"><td className="table-sub-header" colSpan={4}>
                                                ...
                                                <span className={dataGreatLeague ? dataGreatLeague.elidge ? '' : "text-danger" : ''}>Great League{dataGreatLeague ? dataGreatLeague.elidge ? "" : <span> (Not Elidge)</span>: ""}</span>
                                            </td></tr>
                                            <tr>
                                                <td>Level</td>
                                            ...
                                            <tr className="text-center"><td className="table-sub-header" colSpan={4}>
                                                ...
                                                <span className={dataUltraLeague ? dataUltraLeague.elidge ? '' : "text-danger" : ''}>Ultra League{dataUltraLeague ? dataUltraLeague.elidge ? "" : <span> (Not Elidge)</span> : ""}</span>
                                            </td></tr>
                                            <tr>
                                                <td>Level</td>
