...
const CalculatePoint = () => {
    ...
    const [moveDef, setMoveDef] = useState(null);
    ...
    const setIconBattle = (mode, pri, sec) => {
        return (
                    ...
                    <div className="row">
                        <div className="col-lg-4">
                            ...
                            <div style={{width: 300, margin: 'auto'}}>
                                ...
                                {findStabType(formDef.form.types.map(item => item.type.name), moveDef.type)}
                                <p>- Damage: <b>{moveDef.pve_power}
                                {findStabType(formDef.form.types.map(item => item.type.name), moveDef.type) && <span className={"caption-small text-success"}> (x1.2)</span>}
                                </b></p>
                            </div>
                            }
                        ...
                        <div className="col-lg-4">
                            ...
                            <div style={{marginBottom: 15}}>
                                ...
                                <div className="element-top" style={{width: 300, margin: 'auto'}}>
                                    ...
                                    {findStabType(formDef.form.types.map(item => item.type.name), fMove.type)}
                                    <p>- Damage: <b>{fMove.pve_power}
                                    {findStabType(formDef.form.types.map(item => item.type.name), fMove.type) && <span className={"caption-small text-success"}> (x1.2)</span>}
                                    </b></p>
                                </div>
                                }
                            </div>
                            <div>
                                ...
                                <div className="element-top" style={{width: 300, margin: 'auto'}}>
                                    ...
                                    {findStabType(formDef.form.types.map(item => item.type.name), cMove.type)}
                                    <p>- Damage: <b>{cMove.pve_power}
                                    {findStabType(formDef.form.types.map(item => item.type.name), cMove.type) && <span className={"caption-small text-success"}> (x1.2)</span>}
                                    </b></p>
                                </div>
                                }
                            </div>
