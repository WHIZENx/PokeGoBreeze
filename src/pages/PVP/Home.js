...
const PVPHome = () => {
    ...
    const renderLeagueLogo = (logo, cp) => {
    ...
    const renderLeagueName = (name, cp) => {
        if (name === "All") {
        ...
        <div className="container element-top element-bottom">
            <div className="d-flex align-items-center justify-content-between">
                ...
                <Form.Select style={{height: "fit-content"}} className="w-25 form-control" value={rank.id}
                    onChange={(e) => setOptions({...options, rank: pvp.rankings.find(item => item.id === e.target.value)})}>
            ...
            <div className="d-flex align-items-center justify-content-between">
                ...
                <Form.Select style={{height: "fit-content"}} className="w-25 form-control" value={team.id}
                    onChange={(e) => setOptions({...options, team: pvp.trains.find(item => item.id === e.target.value)})}>
