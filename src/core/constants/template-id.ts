export class TemplateId {
  ...
  public static CombatLeague = 'COMBAT_LEAGUE';
  public static CombatLeagueSeeker = 'COMBAT_LEAGUE_VS_SEEKER';
  public static CombatSeasonSetting = 'COMBAT_COMPETITIVE_SEASON_SETTINGS';
}
