        ...
        <Fragment>
            ...
            <div className='d-flex align-items-center'>
                <div style={{width: 64, marginRight: 15}}>
                    <img className='pokemon-sprite-medium' alt='img-pokemon' src={findAssetForm(props.id, props.name) ? APIService.getPokemonModel(findAssetForm(props.id, props.name)) : APIService.getPokeFullSprite(props.id)}/>
                </div>
                <div>
