...
const Stats = (props: any) => {
    ...
    const isAvailable: any = useRef({attack: {bool: false, rank: null}, defense: {bool: false, rank: null}, stamina: {bool: false, rank: null}});
    ...
    const filterRank = (type: string, stats: number) => {
        ...
        let avgRank = props.pokemonStats[type].max_rank - props.pokemonStats[type].ranking.find((item: { [x: string]: number; }) => item[type] > stats).rank;
