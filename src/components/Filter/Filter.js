// Thank angel-rs for css-color-filter-generator
class Color {
    constructor(r, g, b) {
      this.set(r, g, b);
    }
...
export const computeColor = (r, g, b, a) => {
    return `rgb(${Math.round(255*r)}, ${Math.round(255*g)}, ${Math.round(255*b)}, ${a})`
}

export const computeFilter = (r, g, b) => {
    const color = new Color(Math.round(255*r), Math.round(255*g), Math.round(255*b));
