...
const Hexagon = (props: { defaultStats?: any; stats: any; size: any; animation: any; borderSize: any; }) => {
    ...
    const drawLineHex = useCallback((ctx: { beginPath: () => void; moveTo: (arg0: any, arg1: any) => void; lineTo: (arg0: any, arg1: any) => void; setLineDash: (arg0: number[]) => void; fillStyle: string; fill: () => void; lineWidth: number; strokeStyle: any; stroke: () => void; closePath: () => void; }, center: any, percentage: any, color: any, fill: any) => {
    ...
    const drawHexagon = useCallback((stats: any) => {
