...
const Fill: any =  styled.div`
    ...
    clip: rect(${(props: any) => props.size-(props.energy*props.size/props.moveEnergy)}px, ${(props: any) => props.size}px, ${(props: any) => props.size}px, 0px);
...
const IconFill: any =  styled.div`
    ...
    height: ${(props: any) => props.size/2}px;
    transform: translate(-50%, -50%);
    clip: rect(${(props: any) => ((props.size/2)+(((props.size)-(props.size/2))/2))-(props.energy*((props.size/2)+(((props.size)-(props.size/2))))/props.moveEnergy)}px, ${(props: any) => props.size/2}px, ${(props: any) => props.size/2}px, 0px);
    mask: url(${(props: any) => props.url}) center/contain;
    background: white;
    transition: 0.1s;
`;
